...
export const metadata: Metadata = {
  title: "Pricing — Pcat Premium",
  description: "Unlock unlimited Pcat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=pcat&cadence=annual`;
