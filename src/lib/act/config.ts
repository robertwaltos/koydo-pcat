// Auto-generated shim — re-exports from @/lib/pcat/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as PcatConfig } from "@/lib/pcat/config";
import { EXAM_CONFIG as _raw } from "@/lib/pcat/config";

type RawExamConfig = PcatConfig & {
  category?: string;
  locale?: string;
  isRTL?: boolean;
